...
import { ActiveCall, ActiveGroupCall, CallButton, IncomingCallModal } from '@/components/calls'
import { WebRTCProvider } from '@/components/calls/WebRTCProvider'
...
import { useActiveGroupCallId, useCallStore } from '@/lib/stores/callStore'
...
export default function MessengerPage() {
	...
	const handleAcceptCall = async (callerSocketId: string) => {
		try {
			// Use incomingCall from store to populate info
			const info =
