# Video checker temporarily disabled to save disk space (~8 GB of analysis packages).
# To re-enable, restore the original imports/function bodies and reinstall
# openai-whisper, safetext and nudenetv2.
...
#
#
# def _trim_text(text: str | None, limit: int = 800):
#     if not text:
#         return text
#     return text[:limit]
#
