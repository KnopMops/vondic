...
class User(db.Model):
    ...
    access_token_lookup = db.Column(TEXT, unique=True, nullable=True)
    refresh_token_lookup = db.Column(TEXT, unique=True, nullable=True)
    ...
    reset_ip_required = db.Column(TEXT, default=None)
    reset_verify_token = db.Column(TEXT, default=None)
