...
with app.app_context():
    ...
    if db.engine.dialect.name == "sqlite":
        ...
        ensures = [
            ("ALTER TABLE users ADD COLUMN gifts TEXT",
             "gifts"),
            ("ALTER TABLE users ADD COLUMN storis TEXT",
             "storis"),
            ("ALTER TABLE users ADD COLUMN profile_bg_image TEXT",
             "profile_bg_image"),
            ("ALTER TABLE users ADD COLUMN blocked_by_admin TEXT",
             "blocked_by_admin"),
            ...
            ("ALTER TABLE users ADD COLUMN video_channel_id TEXT",
             "video_channel_id"),
            ...
            ("ALTER TABLE users ADD COLUMN video_likes TEXT",
             "video_likes"),
            ("ALTER TABLE users ADD COLUMN video_watch_later TEXT",
                "video_watch_later",
             ),
            ("ALTER TABLE users ADD COLUMN video_history TEXT",
             "video_history"),
        ]
